...
def daily_total(data):
    ...
    ;PAram note: A 2D Pandas data frame with measurement data
     Index must be np.datetime64 compatible format

    ;returns: It returns the summation value of the measurement per day
...
def daily_mean(data):
    ...
    ;returns: It returns the average of the measurement per day
...
def daily_max(data):
    ...
    ;returns: It returns the maximum value of the measurement per day
    """
